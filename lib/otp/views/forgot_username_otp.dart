...
class ForgotOTPScreen extends StatefulWidget {
  ...
  ForgotOTPScreen({super.key, required this.enteredNumberOrEmail});
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: OTPTextField(
                        ...
                        onChanged: (pin) {
                          otpController.forgotOtp.value = pin;
                        },
                        onCompleted: (pin) {
                          otpController.forgotOtp.value = pin;
                        },
                    ...
                    CustomTextField(
                      ...
                      onChanged: (value) {
                        setState(() {
                          otpController.username.value = value;
                        });
                      },
                    ),
                    const SizedBox(height: 15),
                    GestureDetector(
                      onTap: () {
                        loginController.forgotMobileNumber;
                      },
                      child: Text.rich(
                        TextSpan(
                          children: [
                    ...
                    apiService.isLoading.value == true
                      ...
                      child: CustomButton(
                        ...
                        onPressed: ()async {
                          ...
                          if(otpController.username.value.isNotEmpty ){

                          await otpController.forgotOtpVerify();
                          }
                          else{

                            Get.snackbar('UserName', "Your username can not be empty and not less then 6 letters");
                          }
