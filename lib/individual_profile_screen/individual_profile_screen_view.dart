...
class _IndividualProfileScreenViewState extends State<IndividualProfileScreenView> {
              ...
              children: [
                ...
                Row(
                  children: [
                    Expanded(
                        child:
                CustomTextview(individualProfileController
                    .firstname.value,Icons.person),
                            ),

                    Expanded(
                        child:     CustomTextview(individualProfileController
                            .lastname.value,Icons.person),
                    ),

                  ],
                ),
                CustomTextFieldview(individualProfileController.bio.value,Icons.description),
                ...
                Row(
                  children: [
                    Expanded(
                      child:
                        CustomTextview(individualProfileController.dob.value, Icons.calendar_month),
                    /*  CustomDateField(
                        validate: true,
                     ...
                     Expanded(
                      child:  CustomTextview(individualProfileController.gender.value, Icons.calendar_month),
                ...
                Row(
                  children:  [
                    Expanded(
                      child:
                      CustomTextview(individualProfileController.qualification.value, Icons.description_outlined),
                      //QualificationWidget(),
                    ),
                    Expanded(
                      child:  CustomTextview(individualProfileController.occupation.value, Icons.work),
                ...
                Row(
                  children:  [
                    Expanded(
                      child:
                      CustomTextview(individualProfileController.country.value, Icons.location_on),
                      //QualificationWidget(),
                    ),
                    Expanded(
                      child:  CustomTextview(individualProfileController.state.value, Icons.location_on),
                ...
                Row(
                  children:  [
                    Expanded(
                      child:
                      CustomTextview(individualProfileController.city.value, Icons.location_city),
                      //QualificationWidget(),
                    ),
                    Expanded(
                      child:  CustomTextview(individualProfileController.pincode.value, Icons.pin_drop),
      ...
      child: Row(
        children: [
          ...
          NeumorphicText(text,
              ...
              textStyle: NeumorphicTextStyle(fontSize: 14,)),
