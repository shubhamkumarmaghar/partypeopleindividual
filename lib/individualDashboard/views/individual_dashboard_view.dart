...
class IndividualDashboardView extends StatefulWidget {
  ...
  @override
  State<IndividualDashboardView> createState() => _IndividualDashboardViewState();
}

class _IndividualDashboardViewState extends State<IndividualDashboardView> with SingleTickerProviderStateMixin {
  IndividualDashboardController individualDashboardController = Get.put(IndividualDashboardController());
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        showExitAlertDialog(context: context);
        return false;
      },
      child: SafeArea(
                        ...
                        Obx(() {
                          ...
                          return GestureDetector(
                            ...
                            child: Icon(Icons.favorite,
                                color: wishlistController.wishlistedParties.isEmpty ? Colors.white : Colors.red),
                          );
                        }),
                        const SizedBox(
                          width: 10,
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Lottie.network(
                                      ...
                                      height: 40,
                                      width: 40,
                                      animate: individualDashboardController.notificationCount.value.toString() == '0'
                                          ? false
                                          : true,
                                      fit: BoxFit.cover
                                      //fit: BoxFit.cover
                            ...
                            children: [
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: TextField(
                                          onTap: () {
                                            Get.to(PeopleList(
                                              peopleList: individualDashboardController.usersList,
                                            ))?.then((value) => individualDashboardController.getDataForDashboard());
                                          },
                                          readOnly: true,
                                          //  enabled: false,
                                          decoration: InputDecoration(
                                              ...
                                              hintStyle: TextStyle(
                                                  color: Colors.grey, fontSize: 11.sp, fontFamily: 'Poppins')),
                                        ),
                                      ),
                                    ),
                                  ],
                              ...
                              Container(
                                ...
                                child: ListView.builder(
                                  shrinkWrap: true,
                                  itemCount: individualDashboardController.allCityList.length,
                                  ...
                                  itemBuilder: ((context, index) => GestureDetector(
                                        onTap: () {
                                          ...
                                          if (index == 0) {
                                            ...
                                            if (index == 0) {
                                              individualDashboardController.individualProfileController.activeCity
                                                  .value = individualDashboardController.allCityList[index].name;
                                              individualDashboardController.apiService.updateActiveCity(
                                        ...
                                        child: CityCard(
                                          cityName: individualDashboardController.allCityList[index].name,
                                          imageURL: individualDashboardController.allCityList[index].imageUrl,
                                        ),
                                      )),
                                ),
                              ),
                              ...
                              individualDashboardController.noUserFoundController.value == 'null'
                                  ? Container(
                                      /*    decoration: const BoxDecoration(
                              gradient: LinearGradient(
                                colors: [
                                  ...
                                  Color(0xFF711b1b),
                                      ...
                                      child: ListView.builder(
                                        shrinkWrap: true,
                                        itemCount: individualDashboardController.usersList.length,
                                        scrollDirection: Axis.horizontal,
                                        itemBuilder: ((context, index) => GestureDetector(
                                              onTap: () {
                                                if (individualDashboardController.approvalStatus.value == '1') {
                                                  Get.to(() => IndividualPeopleProfile(),
                                                          arguments: individualDashboardController.usersList[index].id)
                                                      ?.then((value) =>
                                                          individualDashboardController.getDataForDashboard());
                                                } else {
                                                  Get.snackbar('Sorry!',
                                              ...
                                              child: NearByPeopleProfile(
                                                ...
                                                setHeart: (val) {
                                                  individualDashboardController.usersList[index].likeStatus = val;
                                                },
                                                ...
                                                onlineStatus:
                                                    individualDashboardController.usersList[index].onlineStatus,
                                                privacyStatus:
                                                    individualDashboardController.usersList[index].privacyOnline,
                                                profile_pic_approval_status:
                                                    individualDashboardController.usersList[index].profilePicApproval,
                                              ),
                                            )),
                                      ),
                                    )
                              ...
                              individualDashboardController.jsonPartyPopularData.isEmpty
                                  ...
                                  : Container(
                                      ...
                                      child: ListView.builder(
                                        scrollDirection: Axis.horizontal,
                                        itemCount: individualDashboardController.lengthOfPopularParties.value,
                                        itemBuilder: (context, index) {
                                          return PartyCard(
                                              party: individualDashboardController.jsonPartyPopularData[index],
                                              onBack: () => () {},
                                              /* individualDashboardController
                                                .getDataForDashboard(),*/
                                              partyType: 'popular');
                              ...
                              individualDashboardController.jsonPartyOrganisationDataToday.isEmpty
                                  ? Center(
                                      child: Padding(
                                  ...
                                  : Container(
                                      ...
                                      child: ListView.builder(
                                        scrollDirection: Axis.horizontal,
                                        itemCount: individualDashboardController.jsonPartyOrganisationDataToday.length,
                                        itemBuilder: (context, index) {
                                          return PartyCard(
                                            party: individualDashboardController.jsonPartyOrganisationDataToday[index],
                                            onBack: () => () {},
                                            /* individualDashboardController
                                              .getDataForDashboard(),*/
                                            partyType: 'today',
                              ...
                              individualDashboardController.jsonPartyOrganisationDataTomm.isEmpty
                                  ? Center(
                                      child: Padding(
                                        padding: const EdgeInsets.all(12.0),
                                        child: Column(
                                  ...
                                  : Container(
                                      ...
                                      child: ListView.builder(
                                        scrollDirection: Axis.horizontal,
                                        itemCount: individualDashboardController.jsonPartyOrganisationDataTomm.length,
                                        itemBuilder: (context, index) {
                                          return PartyCard(
                                            party: individualDashboardController.jsonPartyOrganisationDataTomm[index],
                                            onBack: () => () {},
                                            /*individualDashboardController
                                              .getDataForDashboard(),*/
                                            partyType: 'tommorow',
                              ...
                              individualDashboardController.jsonPartyOgranisationDataUpcomming.isEmpty
                                  ? Center(
                                      child: Padding(
                                        padding: const EdgeInsets.all(12.0),
                                        child: Column(
                                  ...
                                  : Container(
                                      ...
                                      child: ListView.builder(
                                        scrollDirection: Axis.horizontal,
                                        itemCount:
                                            individualDashboardController.jsonPartyOgranisationDataUpcomming.length,
                                        itemBuilder: (context, index) {
                                          return PartyCard(
                                            party:
                                                individualDashboardController.jsonPartyOgranisationDataUpcomming[index],
                                            onBack: () => () {},
                                            /*individualDashboardController
                                              .getDataForDashboard(),*/
                                            partyType: 'upcoming',
                    ...
                    Obx(
                      () {
                        return Container(
                            height: Get.height,
                            width: Get.width,
                            child: individualDashboardController.showAnimatedHeart.value
                                ? Align(
                                    alignment: Alignment.center,
                                    child: Lottie.network(
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            cityName,
            style: TextStyle(color: Colors.white, fontFamily: 'Poppins', fontSize: 10.sp),
          ),
        ],
      ),
    );
...
class ChoiceSelectionButton extends StatelessWidget {
  ChoiceSelectionButton({super.key, required this.buttonState, required this.textVal});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      margin: EdgeInsets.symmetric(
          vertical: MediaQuery.of(context).size.height * 0.01, horizontal: MediaQuery.of(context).size.width * 0.02),
      decoration: BoxDecoration(
                    ...
                    child: Column(children: [
                      ...
                      Row(
                        children: [
                          Text(
                            'TODAY - ',
                            style: TextStyle(fontFamily: 'Poppins', fontSize: 7.sp, color: Colors.black),
                          ),
                          Text(
                            eventTime,
                            style: TextStyle(fontFamily: 'Poppins', color: Colors.red, fontSize: 7.sp),
                          ),
                        ],
                      ),
                      SizedBox(
                      ...
                      Text(
                        eventDescription,
                        style: TextStyle(color: const Color(0xFF564d4d), fontFamily: 'Poppins', fontSize: 7.sp),
                      ),
                      Row(
